  ...
  const announcements = [
    {
      id: 12,
      title: "$BULL 领取操作步骤",
      titleEn: "$BULL Claim Step-by-Step Guide",
      content: "各位合伙人：\n\n为方便大家顺利领取 $BULL，现将操作步骤整理如下：\n\n1. 连接钱包：打开官网，将网络切换到 BNB Smart Chain (BSC) 主网，连接你的钱包地址。\n\n2. 进入「$BULL 领取中心」：桌面端在左侧菜单选择「BULL 领取」；手机端点击底部「更多」→「BULL 领取」。\n\n3. 白名单校验：页面会自动读取你的地址是否在白名单内，并显示总额度。若显示不在名单，请更换正确地址或联系客服核实。\n\n4. 兑换（Migrate）：点击「兑换 $BULL（立即 3%）」按钮，在钱包弹窗中确认交易。成功后 3% 立即到账，其余 97% 进入线性锁仓。\n\n5. 领取解锁：兑换完成后，随着时间推移锁仓部分会持续解锁。回到页面点击「领取 xxx $BULL」，在钱包中确认，即可将已解锁部分转入钱包。\n\n6. 查看余额与交易：领取到钱包的 BULL 可在 PancakeSwap 交易；卖出可能收取卖税用于回流流动性。建议在 45 天内熟悉 PancakeSwap 的兑换流程。\n\n7. 温馨提示：一切请以链上数据为准，切勿轻信任何私聊转账、代领代兑指令。操作中遇到问题请通过官方渠道联系客服。\n\n感谢理解与支持。",
      contentEn: "Dear Partners:\n\nTo help everyone claim $BULL smoothly, here are the step-by-step instructions:\n\n1. Connect Wallet: Open the official website, switch your network to BNB Smart Chain (BSC) Mainnet, and connect your wallet.\n\n2. Open the \"$BULL Claim Center\": On desktop, select \"BULL Claim\" from the left sidebar; on mobile, tap the bottom \"More\" menu → \"BULL Claim\".\n\n3. Whitelist Check: The page automatically checks whether your address is whitelisted and displays your total entitlement. If your address is not listed, switch to the correct address or contact support.\n\n4. Migrate: Click the \"Migrate $BULL (3% instant)\" button and confirm the transaction in your wallet. Once successful, 3% is credited immediately and the remaining 97% enters linear vesting.\n\n5. Claim Unlocked Portion: After migration, the vested portion unlocks continuously over time. Return to the page and click \"Claim xxx $BULL\", then confirm in your wallet to transfer the unlocked portion to your wallet.\n\n6. Check Balance & Trade: BULL received in your wallet can be traded on PancakeSwap; sells may incur a tax used to replenish liquidity. We recommend getting familiar with PancakeSwap within 45 days.\n\n7. Important: Always rely on on-chain data as the source of truth. Never trust private messages asking you to transfer funds or claim on your behalf. If you encounter any issues, contact support through official channels.\n\nThank you for your understanding and support.",
      date: "2026-07-22",
      time: "11:00 CEST",
