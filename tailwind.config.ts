	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'breathing-red': 'breathing-red 3s ease-in-out infinite',
			},
			keyframes: {
				'accordion-down': {
					from: {
				...
				'breathing-red': {
					...
					"50%": {
						backgroundColor: "hsl(0 84% 65%)",
						boxShadow: "0 0 40px hsl(0 84% 60% / 0.7), 0 0 80px hsl(0 84% 60% / 0.4), 0 0 120px hsl(0 84% 60% / 0.2)",
						transform: "scale(1.02)",
					},
				},
			}
